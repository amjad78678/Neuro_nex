      ...
      <div className="flex flex-col gap-10">
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-lg md:text-xl text-slate-500">
        ...
        <div className="flex gap-4 items-end border-b border-slate-400 overflow-x-scroll no-scrollbar">
          {[
            "Web Development",
            "It Certifications",
            "Leadership",
            ...
            <h1
              ...
              className={`font-bold cursor-pointer pb-3 text-sm md:text-xl whitespace-nowrap
            ${
              activeTab === tab
        ...
        <div className="flex gap-5 mb-4">
          ...
          <div className="bg-slate-200 text-black px-6 py-3 rounded-full">
            <h1 className="font-bold whitespace-nowrap">Javascript</h1>
            <p className="text-sm whitespace-nowrap">13.5k learners</p>
          </div>
          <div className="bg-slate-200 text-black px-6 py-3 rounded-full">
            <h1 className="font-bold whitespace-nowrap">React JS</h1>
            <p className="text-sm whitespace-nowrap">13.5k learners</p>
          </div>
          <div className="bg-slate-200 text-black px-6 py-3 rounded-full">
            <h1 className="font-bold whitespace-nowrap">Angular</h1>
            <p className="text-sm whitespace-nowrap">13.5k learners</p>
          </div>
        </div>
